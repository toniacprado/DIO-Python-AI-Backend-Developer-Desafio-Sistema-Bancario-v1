...
# Função tratar os inputs e aceitar somente entrada de valores numéricos
...
while True:
    ...
    if opcao.upper() == "D":
        ...
        if numero_saques < LIMITE_SAQUES:
            valor = input_float(f"O limite por saque é R$ {limite:.2f}. Digite o valor que deseja sacar: ")
